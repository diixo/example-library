...
// original source: https://github.com/diixo/embedded-resources/blob/master/examples/cpp/dispatch.cpp
...
int main(void)
{
   dispatch_queue q("Dispatch Queue [...]", 4);

   q.dispatch([] {printf("Dispatch id=0\n"); });
   q.dispatch([] {printf("Dispatch id=1\n"); });
   q.dispatch([] {printf("Dispatch id=2\n"); });
   q.dispatch([] {printf("Dispatch id=3\n"); });
